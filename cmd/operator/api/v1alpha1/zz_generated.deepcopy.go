...
func (in *ProfileSpec) DeepCopyInto(out *ProfileSpec) {
	*out = *in
	...
	out.MatcherService = in.MatcherService
	out.DispenserService = in.DispenserService
	if in.MatchmakingQueues != nil {
		in, out := &in.MatchmakingQueues, &out.MatchmakingQueues
		*out = make([]*MatchmakingQueue, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MatchmakingQueue)
